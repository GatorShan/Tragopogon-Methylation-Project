...
#SBATCH --job-name=bismark_methylation_extractor_S2_V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=bismark_methylation_extractor_S2_V1_%j.out
#SBATCH --error=bismark_methylation_extractor_S2_V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
