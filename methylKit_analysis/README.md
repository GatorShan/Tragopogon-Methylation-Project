...
"difference: cutoff for ABSOLUTE VALUE of methylation percentage change between test and control (default:25)"; <mark>THIS NUMBER SHOULD BE CHANGED FOR DIFFERENT CONTEXT!!!</mark>
