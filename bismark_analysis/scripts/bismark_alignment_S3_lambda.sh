...
#SBATCH --job-name=bismark_alignment_S3_lambda
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=bismark_alignment_S3_lambda_%j.out
#SBATCH --error=bismark_alignment_S3_lambda_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUT=/orange/soltis/shan158538/Methylation_output/bismark_alignment/S3_lambda
