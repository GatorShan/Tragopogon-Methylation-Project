...
#SBATCH --job-name=AddReadGroup.V2
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=AddReadGroup.V2_%j.out
#SBATCH --error=AddReadGroup.V2_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
### platform name is ILLUMINA although reads are generated from BGISEQ
