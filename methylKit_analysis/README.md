...
### 2.2 Read Bismark alignment; for T. dubius, T. pratensis, and T. miscellus; mincov = 10
...
### 2.3 Read Bismark alignment with the minimum read coverage to call a mehtylation status for a base is 5 (mincov = 5)
...
### 2.4 Read Bismark alignment with the minimum read coverage to call a mehtylation status for a base is 1 (mincov = 1)
