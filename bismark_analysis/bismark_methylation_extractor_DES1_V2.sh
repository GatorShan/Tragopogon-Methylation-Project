...
#SBATCH --job-name=bismark_methylation_extractor_DES1_V2
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=bismark_methylation_extractor_DES1_V2_%j.out
#SBATCH --error=bismark_methylation_extractor_DES1_V2_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
