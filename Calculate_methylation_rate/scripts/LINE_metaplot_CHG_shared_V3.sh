...
#SBATCH --job-name=LINE_metaplot_CHG_shared_V3
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=LINE_metaplot_CHG_shared_V3_%j.out
#SBATCH --error=LINE_metaplot_CHG_shared_V3_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
MTYPE=CHG
TE_TYPE=LINE
GFF=/blue/soltis/shan158538/Methylation/OutPut/TE_annotation_new/repeat_annotation_combined_LINE.final.gff
