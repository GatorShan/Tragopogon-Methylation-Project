...
#SBATCH --job-name=Reformat_CHH_cov_files_shared_V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=Reformat_CHH_cov_files_shared_V1_%j.out
#SBATCH --error=Reformat_CHH_cov_files_shared_V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
