...
Lastly, generate a [SNP file](https://1drv.ms/t/s!AlezkjLj5kLLhMhwUJVgx_NJWA2eLA?e=jHXoDw) (**`SNP_file_homo_snps_header.txt`**) containing only snps (w/o any indel) with homozygous altnernative alleles, which will be used in downstream analysis.
```
SNP-ID	Chromosome	Position	Strand	Ref/SNP
.	Tdub_V1_scaffold_1	754	.	A/G
.	Tdub_V1_scaffold_1	2610	.	C/G
