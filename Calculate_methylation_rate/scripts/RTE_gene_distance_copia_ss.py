...
import numpy as np
RTE_tab = r'/blue/soltis/shan158538/Methylation/OutPut/TE-gene_distance/repeat_annotation_combined_Copia.final_4.gff' #r'D:\Programming\R_working\Tyrran_paper\TEclassification7.tab'
