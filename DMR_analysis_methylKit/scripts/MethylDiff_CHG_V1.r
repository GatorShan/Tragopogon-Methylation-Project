...
# Annalyzing CHG context between Tdu and Tpr
setwd("/blue/soltis/shan158538/Methylation/OutPut/DMR_methylkit/CHG_Tdu_vs_Tpr")

file.list_1 = list("/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tdu_1_CHG.txt",
				 "/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tdu_2_CHG.txt",
				 "/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tpr_1_CHG.txt",
                 "/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tpr_2_CHG.txt")
...
# Annalyzing CHG context between Tms-du and Tms-pr
setwd("/blue/soltis/shan158538/Methylation/OutPut/DMR_methylkit/CHG_Tms-du_vs_Tms-pr")

file.list_2 = list("/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_1_du_CHG.txt",
				 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_2_du_CHG.txt",
				 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_1_pr_CHG.txt",
                 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_2_pr_CHG.txt")
...
# Annalyzing CHG context between Tdu and Tms-du
setwd("/blue/soltis/shan158538/Methylation/OutPut/DMR_methylkit/CHG_Tdu_vs_Tms-du")

file.list_3 = list("/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tdu_1_CHG.txt",
				 "/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tdu_2_CHG.txt",
				 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_1_du_CHG.txt",
				 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_2_du_CHG.txt") 
...
# Annalyzing CHG context between Tpr and Tms-pr
setwd("/blue/soltis/shan158538/Methylation/OutPut/DMR_methylkit/CHG_Tpr_vs_Tms-pr")

file.list_4 = list("/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tpr_1_CHG.txt",
				 "/orange/soltis/shan158538/Methylation_output/bismark_deduplicate/Tpr_2_CHG.txt",
				 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_1_pr_CHG.txt",
				 "/blue/soltis/shan158538/Methylation/OutPut/SNPsplit_output/Tms_2_pr_CHG.txt") 
