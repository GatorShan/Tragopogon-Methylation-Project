...
#SBATCH --job-name=bismark_alignment_DES1_V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=bismark_alignment_DES1_V1_%j.out
#SBATCH --error=bismark_alignment_DES1_V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUT=/orange/soltis/shan158538/Methylation_output/bismark_alignment/DES1
