...
#SBATCH --job-name=DNA_metaplot_CHH_shared_V3
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=DNA_metaplot_CHH_shared_V3_%j.out
#SBATCH --error=DNA_metaplot_CHH_shared_V3_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
MTYPE=CHH
TE_TYPE=DNA
GFF=/blue/soltis/shan158538/Methylation/OutPut/TE_annotation_new/repeat_annotation_combined_DNA.final.gff
