...
#SBATCH --job-name=SNPsplit_S5_new_V1
#SBATCH --mail-user=shan158538@ufl.edu
#SBATCH --mail-type=FAIL,END
#SBATCH --output=SNPsplit_S5_new_V1_%j.out
#SBATCH --error=SNPsplit_S5_new_V1_%j.error
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SNPsplit \
	...
	--bisulfite \
	-o ${OUT} \
	${IN}/S5_cat_R1_val_1_bismark_bt2_pe_nameSorted.deduplicated.bam
